...
## ℹ️ Что было исправлено

1. ✅ Dockerfile - убран nginx, используется Nuxt сервер
2. ✅ nuxt.config.ts - добавлено проксирование API
3. ✅ trpc.ts - исправлена ошибка "[nuxt] instance unavailable"
